...
public class gamePanel extends JPanel implements ActionListener {
	...
	static final int UNIT_SIZE = 20;//Can be decreased to increase difficulty
	static final int GAME_UNITS = (SCREEN_WIDTH * SCREEN_HEIGHT) / UNIT_SIZE;
	static final int delay = 75;//Can be decreased to increase difficulty
	...
	public void draw(Graphics g) {
		if(running) {		
			//To understand the grid which we are using
...
//			}
	...
	public void checkHit() { 
		//Check if head touches the body part
		for (int i = bodyParts; i > 0; i--) 
			if((x[0] == x[i]) && y[0] == y[i])
				running = false;
	...
	public void actionPerformed(ActionEvent e) {
		//System.out.println(running); Checking if this is working or not
